...
function generateFileArea1ParameterA(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
...
function generateFileArea3ParameterA(){
  Swal.fire({
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area3_parameterA";
...
function generateFileArea3ParameterB(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area3_parameterB";
...
function generateFileArea3ParameterC(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area3_parameterC";
...
function generateFileArea3ParameterD(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area3_parameterD";
...
function generateFileArea3ParameterE(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area3_parameterE";
...
function generateFileArea3ParameterF(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area3_parameterF";
...
function generateFileArea4ImplementationParameterA(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area4_implementation_parameterA";
...
function generateFileArea4ImplementationParameterB(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area4_implementation_parameterB";
...
function generateFileArea4ImplementationParameterC(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area4_implementation_parameterC";
...
function generateFileArea4ImplementationParameterD(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area4_implementation_parameterD";
...
function generateFileArea4ImplementationParameterE(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area4_implementation_parameterE";
...
function generateFileArea4OutcomesParameterA(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area4_outcomes_parameterA";
...
function generateFileArea4OutcomesParameterB(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area4_outcomes_parameterB";
...
function generateFileArea4OutcomesParameterC(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area4_outcomes_parameterC";
...
function generateFileArea4OutcomesParameterD(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area4_outcomes_parameterD";
...
function generateFileArea4OutcomesParameterE(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area4_outcomes_parameterE";
...
function generateFileArea4SystemParameterA(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area4_system_parameterA";
...
function generateFileArea4SystemParameterB(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area4_system_parameterB";
...
function generateFileArea4SystemParameterC(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area4_system_parameterC";
...
function generateFileArea4SystemParameterD(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area4_system_parameterD";
...
function generateFileArea4SystemParameterE(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area4_system_parameterE";
...
function generateFileArea2ImplementationParameterA(){
  Swal.fire({
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_implementation_parameterA";
...
function generateFileArea2ImplementationParameterB(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_implementation_parameterB";
...
function generateFileArea2ImplementationParameterC(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_implementation_parameterC";
...
function generateFileArea2ImplementationParameterD(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_implementation_parameterD";
...
function generateFileArea2ImplementationParameterE(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_implementation_parameterE";
...
function generateFileArea2ImplementationParameterF(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_implementation_parameterF";
...
function generateFileArea2ImplementationParameterG(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_implementation_parameterG";
...
function generateFileArea2ImplementationParameterH(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_implementation_parameterH";
...
function generateFileArea2OutcomesParameterA(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_outcomes_parameterA";
...
function generateFileArea2OutcomesParameterB(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_outcomes_parameterB";
...
function generateFileArea2OutcomesParameterC(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_outcomes_parameterC";
...
function generateFileArea2OutcomesParameterD(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_outcomes_parameterD";
...
function generateFileArea2OutcomesParameterE(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_outcomes_parameterE";
...
function generateFileArea2OutcomesParameterF(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_outcomes_parameterF";
...
function generateFileArea2OutcomesParameterG(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_outcomes_parameterG";
...
function generateFileArea2OutcomesParameterH(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_outcomes_parameterH";
...
function generateFileArea2SystemParameterA(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_system_parameterA";
...
function generateFileArea2SystemParameterB(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_system_parameterB";
...
function generateFileArea2SystemParameterC(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_system_parameterC";
...
function generateFileArea2SystemParameterD(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_system_parameterD";
...
function generateFileArea2SystemParameterE(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_system_parameterE";
...
function generateFileArea2SystemParameterF(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_system_parameterF";
...
function generateFileArea2SystemParameterG(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_system_parameterG";
...
function generateFileArea2SystemParameterH(){
  Swal.fire({
    title: 'Are you sure?',
    icon: 'question',
    showCancelButton: true,
    ...
    if (result.isConfirmed) {
      var url = "/generatelevel1_area2_system_parameterH";
...
$(".appendedField").remove();
  ...
  if(html == ""){
    ...
    Swal.fire({
      icon: 'error',
      title: 'Oops...',
      text: 'Can\'t find That Parameter in That Area!',
    })
  }
  else{
...
//   '<select data-role="select" name="selectParameter" id="selectParameter" form="drive_form" required>'+
